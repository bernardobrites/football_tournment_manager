...
// Execução da query
$query = "SELECT id, equipa, `nºcamisola`, escalao, COUNT(*) as Pontos FROM mvp WHERE tipo = 2 AND escalao = 'sub-11' GROUP BY  equipa, `nºcamisola`, escalao ORDER BY Pontos DESC;";
