...
// Execução da query
$query = "SELECT id, equipa, nºcamisola, escalao, COUNT(*) as Pontos FROM mvp WHERE tipo = 1 AND escalao = 'sub-8' GROUP BY  equipa, nºcamisola, escalao ORDER BY Pontos DESC;;";
