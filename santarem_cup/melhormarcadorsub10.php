...
// Execução da query
$query = "SELECT id,equipa,nºcamisola,escalao, sum(golos) as golos FROM melhormarcador WHERE escalao='sub-10' GROUP BY equipa,nºcamisola, escalao='sub-10' ORDER BY golos DESC;";
