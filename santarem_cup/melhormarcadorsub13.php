...
// Execução da query
$query = "SELECT id,equipa,nºcamisola,escalao, sum(golos) as golos FROM melhormarcador WHERE escalao='sub-13' GROUP BY equipa,nºcamisola, escalao='sub-13' ORDER BY golos DESC;";
